...
*   **Action:** Create and actively manage a Google Business Profile (formerly Google My Business).
...
*   **Steps to be done:**
    ...
    8.  **Encourage Customer Reviews:** After completing a sale, ask satisfied customers to leave a review on your Google Business Profile. Positive reviews are a massive trust signal for both customers and Google's ranking algorithm.
    9.  **Post Regular Updates:** Once a week or every two weeks, add a post with a photo of a machine or a project. This shows Google that your business is active and engaged.
...
*   **Steps to be done:**
    ...
    2.  **Add a `<meta name="description">`:** This description should also be added to the front matter of your `en/index.md` and `tr/index.md` files, so your site generator can place it in the `<head>` of the final HTML.
        *   **Add to `en/index.md` front matter:**
        ```yaml
        description: "Discover Adventa's Impera FX series of professional flatbed CNC routers. Engineered in Turkey for precision furniture making, interior building, and custom manufacturing. Request a quote today."
        ```
        *   **Add to `tr/index.md` front matter:**
        ```yaml
        description: "Adventa'nın Impera FX serisi profesyonel düz yatak CNC routerlarını keşfedin. Türkiye'de hassas mobilya imalatı, iç mimari ve özel imalat için tasarlandı. Bugün teklif isteyin."
        ```
...
*   **Steps to be done:**
    ...
    4.  Add your property using the "Domain" option. It will ask you to verify ownership by adding a DNS `TXT` record.
    5.  Once verified, navigate to the "Sitemaps" section in the left-hand menu.
    6.  Enter `sitemap.xml` into the box and click "Submit."
    7.  **Regularly Monitor Performance:** Once a month, check the "Performance" report in Search Console to see which search queries are bringing users to your site. Check the "Pages" report to ensure your pages are indexed correctly and have no errors.
...
*   **Steps to be done:**
    1.  **Keyword Research:** Use a free tool like Google Keyword Planner to find terms that your potential customers in Turkey are searching for (e.g., "ahşap CNC," "mobilya CNC router," "reklamcılık için CNC," etc.).
    2.  **Use Keywords in Headings:** Ensure that the main headings (`<h2>`, `<h3>`) on your page use these relevant keywords naturally. For example, change a generic heading like "Our Machines" to "Impera FX: Professional CNC Routers."
    3.  **Expand Machine Descriptions:** For each Impera FX model, add a short paragraph (2-3 sentences) describing its ideal application. For example: "The Impera FX 1325 is the perfect entry-point for small to medium-sized workshops specializing in custom cabinetry and sign making..."
    4.  **Add an "Applications" or "Industries Served" Section:** Create a new section on your page. Add subheadings like `### Furniture & Cabinetry`, `### Sign Making`, `### Interior Architecture`, and write a sentence or two for each, explaining how your machines meet the needs of that industry. This is a natural way to include important keywords.
...
*   **Steps to be done:**
    1.  **Create Social Media Profiles:** Create company profiles on relevant platforms like **LinkedIn** and **YouTube**. Fill them out completely and add a link back to your website. Share photos and videos of your machines on these platforms.
    2.  **Start with Local Directories:** Get your business listed in reputable Turkish business directories, ensuring your name, address, and phone number are consistent.
    3.  **Contact Suppliers/Partners:** If you have suppliers for parts or software (like Syntec or Alphacam), see if they have a "Partners" or "Customers" page where they might be willing to link to your site.
    4.  **Industry Associations:** If you are a member of any manufacturing or woodworking associations in Turkey, ensure your website is listed in their member directory.
    5.  **Focus on Quality, Not Quantity:** Avoid paying for links or using low-quality "spammy" directories. A single link from a well-respected industry website is worth more than hundreds of links from poor-quality sites.
